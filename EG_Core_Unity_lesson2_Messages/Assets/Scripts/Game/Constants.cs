...
public class Constants
{
        ...
        public class ParametersToParse
        {
                ...
                public const string TimeToShow = "TimeToShow";
                public const string DelayToEnable = "DelayToEnable";
                public const string TotalMessages = "TotalMessages";
                public const string TotalOptions = "TotalOptions";
        ...
        public class NakedStrings
        {
                ...
                public const string AudioFX_UI = "InterfacesUI";
