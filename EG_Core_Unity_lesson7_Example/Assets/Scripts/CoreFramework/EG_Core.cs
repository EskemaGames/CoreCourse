...
namespace EG
{
    namespace Core
    {
        public class EG_Core : EG_Singleton<EG_Core>
        {
            ...
            [SerializeField] private float delayTimeToStart = 1f;
            [SerializeField] private FlowDatabaseSystem flowDatabaseController = null;
            ...
            private GameFlowSystem gameFlowController = null;
            ...
            public EG_Scene CurrentScene => sceneChanger.CurrentScene; 
            ...
            private void InitialLoadOnStart()
            {
                ...
                var listFlow = GetFlowData(flowDatabaseController.GetBaseFlowName);
                
                gameFlowController.Init(
                    listFlow,
                    flowDatabaseController.GetInitialStateName);
            ...
            {
                flowDatabaseController.Init();
                gameFlowController = new GameFlowSystem();
                ...
                destroyableSystems.Add(gameFlowController);
            ...
            {
                return flowDatabaseController.GetFlowData(anId);
            }

            public void ChangeToGameCoreFlow(string anId)
            {
                gameFlowController.ChangeFlow(anId);
            }
