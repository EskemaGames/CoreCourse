...
namespace EG
{
    namespace Core.FlowStateMachine
    {
        ...
        /// </summary>
        [System.Serializable]
        public class LoadSceneInstruction : Instruction
        {
            ...
            public LoadSceneInstruction() { }

            public LoadSceneInstruction(List<string> parameters) : base(parameters)
            {
                ...
                var nextFlowAction = base.parameters[Constants.ParametersToParse.NextFlowAction].ToString();
                ...
                var data = new EG_SceneData(bootstrap, nextFlowAction, unitySceneNames);
